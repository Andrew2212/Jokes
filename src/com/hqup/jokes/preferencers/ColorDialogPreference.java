...
/**
 * The ColorDialogPreference class is responsible for displaying a color pallete
 * where the user can select a color from.
 * 
 * @author Casper Wakkers
 *         http://www.cmwmobile.com/index.php?option=com_content&view
 *         =article&id=34&Itemid=44
 */
public class ColorDialogPreference extends DialogPreference {
	...
	private class ColorPickerView extends View {
		...
		private final int[] colors = new int[] { 0xFFFF0000, 0xFFFF00FF,
				0xFF0000FF, 0xFFFFFFFF, 0xffffffff, 0xFF000000, 0xFF00FFFF,
	...
	protected void onPrepareDialogBuilder(Builder builder) {
		...
		int color = getSharedPreferences().getInt("color", Color.BLACK);
